...
pub(crate) const PARSED_OUTPUT_SCHEMA_JSON: &str = r##"{
  ...
  "$defs": {
    ...
    "dimension": {
      "type": "string",
      "enum": ["length", "area", "mass", "time", "volume", "currency", "temperature", "speed", "data", "data_rate", "flow_rate", "concentration", "acceleration", "force", "torque", "pressure", "power", "charge", "voltage", "current", "resistance", "illuminance", "radiation_equivalent_dose", "radioactivity", "angle", "density", "ratio"]
    },
    "provenance": {
      "type": "string",
